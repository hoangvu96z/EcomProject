...
JTable::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_simprovider'.DS.'tables');
...
JSubMenuHelper::addEntry(JText::_('Quản lý theo nhà cung cấp'), 'index.php?option=com_simprovider',true);
...
$classname	= 'SimprovidersController'.$controller;
