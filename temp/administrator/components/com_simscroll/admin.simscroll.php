...
JTable::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_simscroll'.DS.'tables');
...
JSubMenuHelper::addEntry(JText::_('Quản lý chức năng chữ chạy'), 'index.php?option=com_simscroll',true);
// Create the controller
$classname	= 'SimscrollsController'.$controller;
