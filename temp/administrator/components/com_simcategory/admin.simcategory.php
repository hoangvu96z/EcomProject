...
JTable::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_simcategory'.DS.'tables');
...
JSubMenuHelper::addEntry(JText::_('Quản lý theo nhóm sim'), 'index.php?option=com_simcategory',true);
...
$classname	= 'SimcategorysController'.$controller;
